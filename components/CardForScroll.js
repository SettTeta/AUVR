        ...
        <div >
            <Link href={`/browse/${onView}`} style={{ textDecoration: 'none', color: '#000' }}>
                <div className="card mb-4 box-shadow" >
                    <div className="card-header" style={{ verticalAlign: "middle", background:"#dc3545", color:"white" }}>
                        <h5>{title}</h5>
                    </div>
                    ...
                    <div className="card-footer" style={{ verticalAlign: "middle", background:"#dc3545"}}>
                    </div>
